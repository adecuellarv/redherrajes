                    ...
                    <div class="col-12">
                        ...
                        <div class="menu-wrap">
                            <nav class="menu-nav show">
                                <div class="menu-p3 col-12">
                                    <div class="menu-p2 col-12">
                        ...
                        <div class="mobile-menu">
                            ...
                            <nav class="menu-box">
                                <div class="nav-logo"><a href="index.html"><img src="<?php bloginfo('template_url'); ?>/img/logo/logo.png" alt="" title=""></a>
                                </div>
                        ...
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                <div class="logo mb-30">
                                    <a href="index.html"><img src="<?php bloginfo('template_url'); ?>/img/logo/logo.png" alt=""></a>
                                </div>
