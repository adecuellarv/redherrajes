...
function(i) {
	...
	(e = function() {
        ...
        console.log('cambia-active')
        if ($('.slick-active').children('video').length > 0) { console.log('tiene video')
            ...
            if (jQuery(window).width() < 711) {
                if(navigator.userAgent.indexOf("Chrome") != -1 )
                {
                    ...
                    video.setAttribute("src", 'https://www.monorama.com.mx/redherrajes/wp-content/themes/redherrajes/video/video_responsivo.mp4');
                }
                ...
                if(navigator.userAgent.indexOf("Chrome") != -1 )
                {
                    ...
                    video.setAttribute("src", 'https://www.monorama.com.mx/redherrajes/wp-content/themes/redherrajes/video/CorporateLogoHD_Red_de_Herrajes.mp4');
                }
