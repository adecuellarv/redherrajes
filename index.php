<?php get_header('home'); ?>
        ...
        <main>
                            ...
                            <div class="row align-items-center justify-content-center">
                                <div class="col-lg-6">
                                    <div class="h9-slider-img" data-animation-in="fadeInLeft" data-delay-in=".2" data-duration-in="1.5">
                                        <img src="<?php bloginfo('template_url'); ?>/img/slider/h9_slider_img01.png" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                    ...
                    <div class="h9-slider-item" data-background="<?php bloginfo('template_url'); ?>/img/slider/h9_slider_bg.jpg">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-lg-6">
                                    <div class="h9-slider-img" data-animation-in="fadeInLeft" data-delay-in=".2" data-duration-in="1.5">
                                        <img src="<?php bloginfo('template_url'); ?>/img/slider/h9_slider_img02.png" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="h7-slider-content">
                    ...
                    <div class="h9-slider-item" data-background="<?php bloginfo('template_url'); ?>/img/slider/h9_slider_bg.jpg">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-lg-6">
                                    <div class="h9-slider-img" data-animation-in="fadeInLeft" data-delay-in=".2" data-duration-in="1.5">
                                        <img src="<?php bloginfo('template_url'); ?>/img/slider/h9_slider_img03.png" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="h7-slider-content">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-4 col-lg-6 col-md-8 col-sm-10">
                                <div class="h9-discount-item mb-30">
                                    <div class="thumb">
                                        <img src="<?php bloginfo('template_url'); ?>/img/product/h9_discount_banner01.jpg" alt="">
                                    </div>
                                    <div class="content">
                                        <span>breakfast</span>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-8 col-sm-10">
                                <div class="h9-discount-item highlight-discount mb-30">
                                    <div class="thumb">
                                        <img src="<?php bloginfo('template_url'); ?>/img/product/h9_discount_banner02.jpg" alt="">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-8 col-sm-10">
                                <div class="h9-discount-item mb-30">
                                    <div class="thumb">
                                        <img src="<?php bloginfo('template_url'); ?>/img/product/h9_discount_banner03.jpg" alt="">
                                    </div>
                                    <div class="content">
                                        <span>new in</span>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-7 col-lg-9">
                                <div class="cat-section-title text-center">
                                    <div class="icon"><img src="<?php bloginfo('template_url'); ?>/img/icon/logo_icon.png" alt=""></div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="shop-sidebar.html">
                                    <div class="icon">
                                        <img src="<?php bloginfo('template_url'); ?>/img/icon/b_cat_icon01.png" alt="">
                                    </div>
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="shop-sidebar.html">
                                    <div class="icon">
                                        <img src="<?php bloginfo('template_url'); ?>/img/icon/b_cat_icon02.png" alt="">
                                    </div>
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="shop-sidebar.html">
                                    <div class="icon">
                                        <img src="<?php bloginfo('template_url'); ?>/img/icon/b_cat_icon03.png" alt="">
                                    </div>
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="shop-sidebar.html">
                                    <div class="icon">
                                        <img src="<?php bloginfo('template_url'); ?>/img/icon/b_cat_icon04.png" alt="">
                                    </div>
                        ...
                        <div class="col">
                            <div class="shop-cat-item">
                                <a href="shop-sidebar.html">
                                    <div class="icon">
                                        <img src="<?php bloginfo('template_url'); ?>/img/icon/b_cat_icon05.png" alt="">
                                    </div>
            ...
            <section class="h9-choose-area">
                <div class="h9-choose-img" data-background="<?php bloginfo('template_url'); ?>/img/images/h9_choose_img.jpg"></div>
                            ...
                            <div class="h9-choose-content">
                                ...
                                <div class="h9-choose-list">
                                    <ul>
                                        <li>
                                            <div class="icon">
                                                <img src="<?php bloginfo('template_url'); ?>/img/icon/h9_choose_icon01.png" alt="">
                                            </div>
                                            <div class="content">
                                                <h5>Hot Burger</h5>
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="<?php bloginfo('template_url'); ?>/img/icon/h9_choose_icon02.png" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <li>
                                            <div class="icon">
                                                <img src="<?php bloginfo('template_url'); ?>/img/icon/h9_choose_icon03.png" alt="">
                                            </div>
                                            <div class="content">
                                                <h5>Fresh Juice</h5>
                                                <p>Lorem Ipsum placeholder text for use in your graphic, print and web layouts, and discover plugins</p>
                ...
                <div class="container">
                    ...
                    <div class="row new-arrival-active">
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product01.jpg" alt=""></a>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    ...
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product02.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-sidebar.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product03.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-sidebar.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    ...
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product04.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-sidebar.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <div class="discount-tag">- 20%</div>
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product05.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-sidebar.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <div class="discount-tag new">New</div>
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product06.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-sidebar.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-one">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product07.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-sidebar.html"><i class="far fa-eye"></i></a></li>
                        ...
                        <div class="col-xl-3 col-lg-4 col-sm-6 grid-item grid-sizer cat-two">
                            <div class="new-arrival-item text-center mb-50">
                                <div class="thumb mb-25">
                                    ...
                                    <a href="shop-details.html"><img src="<?php bloginfo('template_url'); ?>/img/product/bn_arrival_product08.jpg" alt=""></a>
                                    <div class="product-overlay-action">
                                        <ul>
                                            <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                            <li><a href="shop-sidebar.html"><i class="far fa-eye"></i></a></li>
